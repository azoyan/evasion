...
function Enemy:drawNormal()
  ...
  local angle = math.atan2(player.y - centerY , player.x - centerX)
  local a = { 0, 0, self.color[0], self.color[1], self.color[2] }
  local b = { 0 + self.width, 0,  self.color[0], self.color[1], self.color[2] }
  local c = { 0 + self.width, 0 + self.height,  self.color[0], self.color[1], self.color[2] }
  local d = { 0, 0 + self.height,  self.color[0], self.color[1], self.color[2] }
  ...
  -- mesh:setVertex(3, c)
  -- mesh:setVertex(4, d)
  --love.graphics.polygon("fill", a.x, a.y, b.x, b.y, c.x, c.y, d.x, d.y)
